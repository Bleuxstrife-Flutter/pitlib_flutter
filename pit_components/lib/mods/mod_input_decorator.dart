...
///
/// [ModInputDecorator] displays the visual elements of a Material Design text
/// field around its input [child]. The visual elements themselves are defined
/// by an [ModInputDecoration] object and their layout and appearance depend
/// on the `baseStyle`, `textAlign`, `isFocused`, and `isEmpty` parameters.
///
/// [TextField] uses this widget to decorate its [EditableText] child.
///
/// [ModInputDecorator] can be used to create widgets that look and behave like a
...
class ModInputDecorator extends StatefulWidget {
  ...
  ///
  /// If null, `const InputDecoration()` is used. Null [ModInputDecoration]
  /// properties are initialized with the corresponding values from
  /// [ThemeData.inputDecorationTheme].
  final ModInputDecoration decoration;
  ...
  @override
  _ModInputDecoratorState createState() => _ModInputDecoratorState();

  /// The RenderBox that defines this decorator's "container". That's the
  /// area which is filled if [ModInputDecoration.isFilled] is true. It's the area
  /// adjacent to [ModInputDecoration.icon] and above the widgets that contain
  /// [ModInputDecoration.helperText], [ModInputDecoration.errorText], and
  /// [ModInputDecoration.counterText].
  ///
...
class _ModInputDecoratorState extends State<ModInputDecorator> with TickerProviderStateMixin {
  ...
  ModInputDecoration _effectiveDecoration;
  ModInputDecoration get decoration {
  ...
  @override
  void didUpdateWidget(ModInputDecorator old) {
    super.didUpdateWidget(old);
...
/// Design text field.
///
/// The [TextField] and [ModInputDecorator] classes use [ModInputDecoration] objects
/// to describe their decoration. (In fact, this class is merely the
/// configuration of an [ModInputDecorator], which does all the heavy lifting.)
///
/// See also:
///
///  * [TextField], which is a text input widget that uses an
///    [InputDecoration].
///  * [ModInputDecorator], which is a widget that draws an [ModInputDecoration]
///    around an input child widget.
///  * [Decoration] and [DecoratedBox], for drawing borders and backgrounds
///    around a child widget.
@immutable
class ModInputDecoration {
  ...
  /// [ModInputDecorator] defaults [isDense] to true, and [filled] to false,
  ...
  /// Defines an [ModInputDecorator] that is the same size as the input field.
  ///
  /// This type of input decoration does not include a border by default.
  ///
  /// Sets the [isCollapsed] property to true.
  const ModInputDecoration.collapsed({
  ...
  /// [decoration.content] and above the widgets that contain [helperText],
  ...
  /// The border to display when the [ModInputDecorator] does not have the focus and
  /// is showing an error.
  ///
  /// See also:
  ///  * [ModInputDecorator.isFocused], which is true if the [ModInputDecorator]'s child
  ///    has the focus.
  ///  * [ModInputDecoration.errorText], the error shown by the [ModInputDecorator], if non-null.
  ///  * [border], for a description of where the [ModInputDecorator] border appears.
  ///  * [UnderlineInputBorder], an [ModInputDecorator] border which draws a horizontal
  ///    line at the bottom of the input decorator's container.
  ///  * [OutlineInputBorder], an [ModInputDecorator] border which draws a
  ///    rounded rectangle around the input decorator's container.
  ///  * [InputBorder.none], which doesn't draw a border.
  ///  * [focusedBorder], displayed when [ModInputDecorator.isFocused] is true
  ///    and [InputDecoration.errorText] is null.
  ///  * [focusedErrorBorder], displayed when [ModInputDecorator.isFocused] is true
  ///    and [InputDecoration.errorText] is non-null.
  ///  * [disabledBorder], displayed when [ModInputDecoration.enabled] is false
  ///    and [InputDecoration.errorText] is null.
  ///  * [enabledBorder], displayed when [ModInputDecoration.enabled] is true
  ///    and [InputDecoration.errorText] is null.
  final InputBorder errorBorder;

  /// The border to display when the [ModInputDecorator] has the focus and is not
  /// showing an error.
  ///
  /// See also:
  ///
  ...
  ///    rounded rectangle around the input decorator's container.
  ///  * [InputBorder.none], which doesn't draw a border.
  ///  * [errorBorder], displayed when [ModInputDecorator.isFocused] is false
  ///    and [InputDecoration.errorText] is non-null.
  ///  * [focusedErrorBorder], displayed when [ModInputDecorator.isFocused] is true
  ///    and [InputDecoration.errorText] is non-null.
  ///  * [disabledBorder], displayed when [ModInputDecoration.enabled] is false
  ...
  /// The border to display when the [ModInputDecorator] has the focus and is
  /// showing an error.
  ///
  /// See also:
  ///
  ...
  /// The border to display when the [ModInputDecorator] is disabled and is not
  /// showing an error.
  ///
  /// See also:
  ///
  ///  * [ModInputDecoration.enabled], which is false if the [ModInputDecorator] is disabled.
  ///  * [ModInputDecoration.errorText], the error shown by the [ModInputDecorator], if non-null.
  ///  * [border], for a description of where the [ModInputDecorator] border appears.
  ///  * [UnderlineInputBorder], an [ModInputDecorator] border which draws a horizontal
  ///    line at the bottom of the input decorator's container.
  ...
  /// The border to display when the [ModInputDecorator] is enabled and is not
  /// showing an error.
  ///
  /// See also:
  ///
  ...
  /// The decoration's container is the area which is filled if [isFilled] is
  /// true and bordered per the [border]. It's the area adjacent to
  /// [ModInputDecoration.icon] and above the widgets that contain
  /// [ModInputDecoration.helperText], [ModInputDecoration.errorText], and
  /// [ModInputDecoration.counterText].
  ///
  ...
  /// [ModInputDecoration.errorText], [ModInputDecoration.enabled],
  ...
  /// Used by widgets like [TextField] and [ModInputDecorator] to create a new
  /// [ModInputDecoration] with default values taken from the [theme].
  ///
  /// Only null valued properties from this [ModInputDecoration] are replaced
  /// by the corresponding values from [theme].
  ModInputDecoration applyDefaultsMod(ModInputDecorationTheme theme) {
    return copyWith(
  ...
  /// Only null valued properties from this [ModInputDecoration] are replaced
  /// by the corresponding values from [theme].
  ModInputDecoration applyDefaults(InputDecorationTheme theme) {
    return copyWith(
      labelStyle: labelStyle ?? theme.labelStyle,
      helperStyle: helperStyle ?? theme.helperStyle,
      hintStyle: hintStyle ?? theme.hintStyle,
  ...
  bool operator ==(dynamic other) {
    ...
    if (other.runtimeType != runtimeType)
      return false;
    final ModInputDecoration typedOther = other;
...
/// Defines the default appearance of [ModInputDecorator]s.
///
/// This class is used to define the value of [ThemeData.inputDecorationTheme].
/// The [ModInputDecorator], [TextField], and [TextFormField] widgets use
/// the current input decoration theme to initialize null [ModInputDecoration]
/// properties.
///
/// The [ModInputDecoration.applyDefaults] method is used to combine a input
/// decoration theme with an [ModInputDecoration] object.
@immutable
class ModInputDecorationTheme extends Diagnosticable {
  /// Creates a value for [ThemeData.inputDecorationTheme] that
  /// defines default values for [ModInputDecorator].
  ///
  /// The values of [isDense], [isCollapsed], [isFilled], and [border] must
  /// not be null.
  const ModInputDecorationTheme({
    this.labelStyle,
    this.helperStyle,
    this.hintStyle,
    this.errorStyle,
  ...
  /// The style to use for [ModInputDecoration.labelText] when the label is
  ...
  /// The style to use for [ModInputDecoration.helperText].
  final TextStyle helperStyle;

  /// The style to use for the [ModInputDecoration.hintText].
  ///
  /// Also used for the [labelText] when the [labelText] is displayed on
  /// top of the input field (i.e., at the same location on the screen where
  ...
  /// The style to use for the [ModInputDecoration.errorText].
  ///
  /// If null, defaults of a value derived from the base [TextStyle] for the
  /// input field and the current [Theme].
  final TextStyle errorStyle;
  ...
  /// [ModInputDecoration.isFilled] is true and bordered per the [border].
  /// It's the area adjacent to [ModInputDecoration.icon] and above the
  /// [ModInputDecoration.icon] and above the widgets that contain
  /// [ModInputDecoration.helperText], [ModInputDecoration.errorText], and
  /// [ModInputDecoration.counterText].
  ///
  ...
  /// Whether the decoration is the same size as the input field.
  ///
  /// A collapsed decoration cannot have [ModInputDecoration.labelText],
  /// [ModInputDecoration.errorText], or an [ModInputDecoration.icon].
  final bool isCollapsed;

  /// The style to use for the [ModInputDecoration.prefixText].
  ///
  /// If null, defaults to the [hintStyle].
  final TextStyle prefixStyle;

  /// The style to use for the [ModInputDecoration.suffixText].
  ///
  /// If null, defaults to the [hintStyle].
  final TextStyle suffixStyle;

  /// The style to use for the [ModInputDecoration.counterText].
  ///
  /// If null, defaults to the [helperStyle].
  final TextStyle counterStyle;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    const ModInputDecorationTheme defaultTheme = ModInputDecorationTheme();
