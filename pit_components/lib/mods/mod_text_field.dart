...
/// one of its ancestors to be a [Material] widget. When the [ModTextField] is
/// tapped an ink splash that paints on the material is triggered, see
/// [ThemeData.splashFactory].
///
/// To integrate the [ModTextField] into a [Form] with other [FormField] widgets,
...
///  * [ModInputDecorator], which shows the labels and other visual elements that
...
class ModTextField extends StatefulWidget {
  ...
  const ModTextField({
    ...
    this.controller,
    this.focusNode,
    this.decoration = const ModInputDecoration(),
...
class _ModTextFieldState extends State<ModTextField> with AutomaticKeepAliveClientMixin {
  ...
  @override
  void didUpdateWidget(ModTextField oldWidget) {
